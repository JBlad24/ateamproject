...
urlpatterns = [
    ...
    url(r'^student/question/(?P<quiz_id>[0-9]+)/(?P<question_id>[0-9]+)$', views.student_question_view, name='student_question_view'),
    url(r'^teacher/question/(?P<quiz_id>[0-9]+)/(?P<question_id>[0-9]+)$', views.teacher_question_view, name='teacher_question_view'),
